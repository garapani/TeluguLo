// $Id: RTS.js,v 1.9.1 2007/07/05 07:48:47 veeven Exp $ -->

// Copyright 2005 Nagarjuna Venna <vnagarjuna@yahoo.com>; Changes Copyright 2007 Veeven
...
RTS.toPadma[RTS.misc_LLL] = Padma.consnt_LLA + Padma.vattu_LLA;
...
RTS.isPossibleAnusvara = function(str) { return str == RTS.consnt_NA_1 || str == RTS.consnt_MA_1; }
...
RTS.getRTSWriter = function(wstyle, sstyle) { return new RTS(wstyle, sstyle); }
...
RTS.prototype.transformSyllableConstituent = function(str) {
    ...
    if (this.cache != null && this.sunnaStyle == RTS.sstyle_Classic) {
        if (this.cache == Padma.anusvara) {
            ...
            if (str == Padma.consnt_PA || str == Padma.consnt_PHA || str == Padma.consnt_BA || str == Padma.consnt_BHA || RTS.anusvaraMakerForMOnly[str] != null)
